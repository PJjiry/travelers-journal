...
const About: React.FC = () => {
    ...
    // Render the About page: it contains information about the motivation for this project and functionality of the application
    return (
        <main className={classes.main}>
            ...
            <article className={classes.article}>
                ...
                <p>
                    ...
                    Business. The goal was to create a web application using React.js and TypeScript.
                </p>
                <p>
            ...
            <article className={classes.article}>
                ...
                <p>
                    ...
                    special requirements to enter the
                    location, budget spent on the trip, location in the map and photos.
                    User can also view all trips grouped according the continent and search for specific trip. Each trip
                    has type, which can be either nature or city.
                    If the type is set to city, user can also add the sights he visited during the trip.
                </p>
                <p>
                    The last part of the application is packing list, where user can create his own list of things that
